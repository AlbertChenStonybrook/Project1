# -*- coding: utf-8 -*-
"""
Created on Tue Apr 20 14:44:43 2021
...
#reward=np.loadtxt("reward_test.txt")
acc_cu_tr=[]
acc_cu_val=[]
acc_cu_test=[]
#reward_accu=[]
...
plt.plot(x,acc_cu_val[:len(x)],label="Validation")
plt.plot(x,acc_cu_test[:len(x)],label="Testing")
plt.legend()
